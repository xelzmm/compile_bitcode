...
for ext in .a .dylib; do
	...
	for suffix in "" _marker _bitcode; do
		lipo -create libtest_armv7${suffix}${ext} libtest_arm64${suffix}${ext} -output libtest_iphoneos${suffix}${ext}
		lipo -create libtest_armv7${suffix}${ext} libtest_arm64${suffix}${ext} libtest_i386${ext} libtest_x86_64${ext} -output libtest_all${suffix}${ext}
	done
done